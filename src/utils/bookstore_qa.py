...
<<<<<<< HEAD
    ...
    {"brand": ["oppo", "欧珀"], "virtual_category": ["数码产品"],
        "category": ["手机"], "location": ["一楼"], "store_id":"吴江新华书店"},
    {"brand": ["vivo", "维沃"], "virtual_category": ["数码产品"],
        "category": ["手机"], "location": ["一楼"], "store_id":"吴江新华书店"},
    {"brand": ["华为"], "virtual_category": ["数码产品"],
        "category": ["手机"], "location": ["一楼"]},
    {"brand": ["小天才"], "virtual_category": ["数码产品"], "category": [
    ...
    {"category": ["图书"], "book.category": ["文学类"],
        "location": ["二楼"], "store_id":"吴江新华书店"},
    {"category": ["图书"], "book.category": ["杂志", "期刊", "杂志期刊"],
        "location": ["二楼"], "store_id":"吴江新华书店"},
    {"category": ["图书"], "book.category": ["社会科学", "社科书", "科学书"],
        "location": ["二楼"], "store_id":"吴江新华书店"},
    {"category": ["图书"], "book.category": ["科技", "科技书", "生活书"],
        "location": ["二楼"], "store_id":"吴江新华书店"},
    {"category": ["图书"], "book.category": ["生活书"],
        "location": ["二楼"], "store_id":"吴江新华书店"},
    {"category": ["图书"], "book.category": ["少儿图书"],
        "location": ["三楼"], "store_id":"吴江新华书店"},
    {"brand": ["诺亚舟"], "virtual_category": ["电教产品"], "category": [
        "电子词典"], "location": ["三楼"], "store_id":"吴江新华书店"},
    {"brand": ["步步高"], "virtual_category": ["电教产品"], "category": [
        "学习平板电脑"], "location": ["三楼"], "store_id":"吴江新华书店"},
    {"brand": ["读书郎"], "virtual_category": ["电教产品"], "category": [
        "点读机"], "location": ["三楼"], "store_id":"吴江新华书店"},
    {"brand": ["创想"], "virtual_category": ["电教产品"], "category": [
        "学习桌"], "location": ["三楼"], "store_id":"吴江新华书店"},
    {"category": ["文具", "文化用品"], "location": ["四楼"], "store_id":"吴江新华书店"},
    {"category": ["图书"], "book.category": ["教辅", "小升初", "中考",
                                           "高考"], "location": ["四楼"], "store_id":"吴江新华书店"},
    {"facility": ["收银台", "服务总台"], "location": [
        "一楼的电梯出来后右手边,在屏幕平面图的正上方"], "store_id":"吴江新华书店"},
    {"facility": ["卫生间", "厕所"], "location": [
